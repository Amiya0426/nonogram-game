...
scp -o BatchMode=yes server/index.js server/auth.js server/db.js server/puzzle-lib.js server/solve-worker.mjs server/package.json server/package-lock.json "${REMOTE}:$APP/server/"
